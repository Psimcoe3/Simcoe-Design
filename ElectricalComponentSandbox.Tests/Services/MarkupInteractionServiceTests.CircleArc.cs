...
public partial class MarkupInteractionServiceTests
{
    ...
    [Fact]
    public void SetArcAngle_StartHandle_KeepsEndFixedForNegativeSweep()
    {
        var markup = new MarkupRecord
        {
            Type = MarkupType.Arc,
    ...
    [Fact]
    public void SetArcAngle_StartHandle_ClampsMinimumPositiveSweep()
    {
        var markup = new MarkupRecord
        {
            Type = MarkupType.Arc,
        ...
        _sut.SetArcAngle(markup, MarkupArcAngleHandle.Start, 90);

        Assert.Equal(90, markup.ArcStartDeg, 6);
    ...
    [Fact]
    public void SetArcAngle_EndHandle_KeepsStartFixedForPositiveSweep()
    {
        var markup = new MarkupRecord
        {
            Type = MarkupType.Arc,
    ...
    [Fact]
    public void SetArcAngle_EndHandle_ClampsMinimumNegativeSweep()
    {
        var markup = new MarkupRecord
        {
            Type = MarkupType.Arc,
    ...
    [Fact]
    public void SetArcAngle_CannotEdit_DoesNothing()
    {
        var modifiedUtc = new DateTime(2024, 1, 2, 3, 4, 5, DateTimeKind.Utc);
        var markup = new MarkupRecord
        {
        ...
        _sut.SetArcAngle(markup, MarkupArcAngleHandle.End, 300);
    ...
    [Fact]
    public void SetArcAngleFromPoint_CannotEdit_DoesNothing()
    {
        var modifiedUtc = new DateTime(2024, 1, 2, 3, 4, 5, DateTimeKind.Utc);
        var markup = new MarkupRecord
        {
        ...
        _sut.SetArcAngleFromPoint(markup, MarkupArcAngleHandle.End, new Point(40, 20), snapIncrementDeg: 15);
